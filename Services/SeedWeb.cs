        ...
        public static void Ejecutar(AppDbContext db)
        {
            ...
            if (!db.ExcursionesWeb.Any())
            {
                db.ExcursionesWeb.AddRange(
                    ...
                    Ex("yungas", "Conociendo las Yungas", "Travesía · 3 días", true, "47,95,80", "yungas-1.webp", 60,
                    ...
                    Ex("yungas-express", "Yungas Express", "Travesía · 2 días", true, "104,138,74", "yungas-express-1.webp", 70,
                    ...
                    Ex("ecolodge", "Especial EcoLodge de la Selva", "Travesía · 3 días", true, "134,124,82", "ecolodge-2.webp", 110,
