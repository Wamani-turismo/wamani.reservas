        ...
        public static void Ejecutar(AppDbContext db)
        {
            ...
            if (!db.ExcursionesWeb.Any())
            {
                db.ExcursionesWeb.AddRange(
                    Ex("atardecer-en-las-salinas", "Atardecer en las Salinas", "Día completo", false, "122,106,160", "salinas-1.webp", 10,
                    ...
                    Ex("recorriendo-la-quebrada", "Recorriendo la Quebrada", "Día completo", false, "112,72,105", "quebrada-1.webp", 20,
                    ...
                    Ex("termas-de-jordan", "Termas de Jordán", "Día completo", false, "58,110,90", "termas-jordan-1.webp", 30,
                    ...
                    Ex("ruta-de-lagunas-y-termas", "Ruta de Lagunas y Termas", "Día completo", false, "63,118,131", "lagunas-2.webp", 40,
                    ...
                    Ex("cascada-santuyoc-y-angosto-de-jaire", "Cascada Santuyoc y Angosto de Jaire", "Día completo", false, "92,125,80", "santuyoc-3.webp", 50,
                    ...
                    Ex("conociendo-las-yungas", "Conociendo las Yungas", "3 días", false, "47,95,80", "yungas-1.webp", 60,
                    ...
                    Ex("tilcara-calilegua", "Tilcara – Calilegua", "Travesía · 5 días", true, "86,132,96", "tilcara-2.webp", 90,
                    ...
                    Ex("iruya-nazareno", "Iruya – Nazareno", "Travesía · 5 días", true, "88,106,140", "iruya-2.webp", 100,
                    ...
                    Ex("especial-ecolodge-de-la-selva", "Especial EcoLodge de la Selva", "3 días", false, "134,124,82", "ecolodge-2.webp", 110,
